...
public class MondrianBaseGameManager : Base_GameManager
{
    //events
    ...
    private void RandomlyChangeColor(Ray ray)
    {
        ...
        foreach (var hit in GameManager_Hits)
        {
            ...
            if (_meshRendererMap.ContainsKey(currentInstance))
            {
                ...
                Managers.Sound.Play(SoundManager.Sound.Effect, "Audio/BasicContents/Mondrian/Click_" + randomChar, 0.2f);
           ...
           //         Debug.Log("sequence is already active..try later");
                        ...
                        .OnComplete(() =>
                            {
                                currentTransform
                                    ...
                                    .OnStart(() =>
                                    {
                                        Managers.Sound.Play(SoundManager.Sound.Effect, "Audio/BasicContents/Mondrian/OnExplosion", 0.4f);
                                    ...
                                    .OnComplete(() =>
                                    {
                                        Managers.Sound.Play(SoundManager.Sound.Effect, "Audio/BasicContents/Mondrian/OnFlowerAppear", 0.4f);
            ...
            else //큰 큐브인 경우------------------------------------------
            {
                ...
                if (_meshRendererMap.ContainsKey(currentInstance))
                {
                    ...
                    Managers.Sound.Play(SoundManager.Sound.Effect, "Audio/BasicContents/Mondrian/OnBunchFlowersAppear", 0.4f);
