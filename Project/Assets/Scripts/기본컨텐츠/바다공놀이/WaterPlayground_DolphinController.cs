    ...
    private void PlayDolphinAnim(Vector3[] path, float duration = 2.88f, float extraDelay = 0f)
    {
        ...
        _seq.Append(transform.DOScale(_defaultSize, 0.55f)
            .OnStart(() =>
            {
                ...
                if (gameObject.name != "IdleDolphin")
                {
                    Managers.soundManager.Play(SoundManager.Sound.Effect, "Audio/기본컨텐츠/WaterPlayground/DolphinA" );
                
                    var randomChar = (char)Random.Range('A', 'B' + 1);
                    Managers.soundManager.Play(SoundManager.Sound.Effect, "Audio/기본컨텐츠/WaterPlayground/DolphinLaugh" + randomChar,0.5f);
                }
                ...
                transform.DOPath(path, duration, PathType.CatmullRom)
                    ...
                    .OnStart(() =>
                    {
                        ...
                        Managers.soundManager.Play(SoundManager.Sound.Effect, "Audio/기본컨텐츠/WaterPlayground/DolphinB" ,1.0f);
