...
public class ShapePathfindingBaseGameManager : Base_GameManager
{
    /*
     *1.랜덤으로 쉐이프, 컬러 할당하기
     *2.주사위 판별 로직 만들기
    ...
    {
        var psPrefab = Resources.Load<ParticleSystem>("SortedByScene/BasicContents/ShapePathFinder/CFX_Correct");
        ...
        // 컬러머터리얼 리소스 로딩 ----------------------------------------------
        var matRed = Resources.Load<Material>("SortedByScene/BasicContents/ShapePathFinder/Material/RuntimeMaterial/M_Red");
        _colorMat[(int)ColorMat.Red] = matRed;

        var matBlue = Resources.Load<Material>("SortedByScene/BasicContents/ShapePathFinder/Material/RuntimeMaterial/M_Blue");
        _colorMat[(int)ColorMat.Blue] = matBlue;

        var matGreen = Resources.Load<Material>("SortedByScene/BasicContents/ShapePathFinder/Material/RuntimeMaterial/M_Green");
        _colorMat[(int)ColorMat.Green] = matGreen;

        var matViolet = Resources.Load<Material>("SortedByScene/BasicContents/ShapePathFinder/Material/RuntimeMaterial/M_Violet");
        _colorMat[(int)ColorMat.Violet] = matViolet;


        // 도형머터리얼 리소스 로딩 ----------------------------------------------
        var matCircle = Resources.Load<Material>("SortedByScene/BasicContents/ShapePathFinder/Material/RuntimeMaterial/M_Circle");
        _shapeMat[(int)ShapeMat.Circle] = matCircle;

        var matSquare = Resources.Load<Material>("SortedByScene/BasicContents/ShapePathFinder/Material/RuntimeMaterial/M_Square");
        _shapeMat[(int)ShapeMat.Square] = matSquare;

        var matTriangle = Resources.Load<Material>("SortedByScene/BasicContents/ShapePathFinder/Material/RuntimeMaterial/M_Triangle");
        _shapeMat[(int)ShapeMat.Triangle] = matTriangle;

        var matHeart = Resources.Load<Material>("SortedByScene/BasicContents/ShapePathFinder/Material/RuntimeMaterial/M_Heart");
