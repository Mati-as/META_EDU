...
public class OriginalHardVer_FishOnWater_UIManager : UI_PopUp
{
    ...
    private OriginalHardVer_FishOnWaterBaseGameManager _gm;
...
//         _sliders[(int)SoundManager.Sound.Effect] = GetObject((int)UI_Type.EffectVolume).GetComponent<Slider>();
    ...
    public override bool InitOnLoad()
    {
        ...
        _gm = GameObject.FindWithTag("GameManager").GetComponent<OriginalHardVer_FishOnWaterBaseGameManager>();
