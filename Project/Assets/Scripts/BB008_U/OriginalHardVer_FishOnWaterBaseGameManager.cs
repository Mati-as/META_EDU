...
public class OriginalHardVer_FishOnWaterBaseGameManager : Base_GameManager
{
   ...
   */
    ...
    protected override void BindEvent()
    {
        ...
        OriginalHardVer_FishOnWater_UIManager.OnStartUIAppear -= OnRoundStart;
        OriginalHardVer_FishOnWater_UIManager.OnStartUIAppear += OnRoundStart;
        OriginalHardVer_FishOnWater_UIManager.OnReadyUIAppear += OnReadyUIAppear;

        OriginalHardVer_FishOnWater_UIManager.OnRestartBtnClicked -= OnRestartBtnClicked;
        OriginalHardVer_FishOnWater_UIManager.OnRestartBtnClicked += OnRestartBtnClicked;

        OriginalHardVer_FishOnWater_UIManager.OnResetXML -= OnXmlReset;
        OriginalHardVer_FishOnWater_UIManager.OnResetXML += OnXmlReset;

        OriginalHardVer_FishOnWater_UIManager.OnResetSettingBtnClicked -= OnResetSetting;
        OriginalHardVer_FishOnWater_UIManager.OnResetSettingBtnClicked += OnResetSetting;

        OriginalHardVer_FishOnWater_UIManager.OnSaveCurrentSettingClicked -= OnSaveCurrentSettings;
        OriginalHardVer_FishOnWater_UIManager.OnSaveCurrentSettingClicked += OnSaveCurrentSettings;
    }
