...
public class DrumBaseGameManager : Base_GameManager
{
    ...
    protected override void Init()
    {
        ...
        SetPool(_effectContainer, "SortedByScene/BasicContents/Drum/MusicInstruments_CFX_Click");
    ...
    public override void OnRaySynced()
    {
        ...
        foreach (var hit in GameManager_Hits)
        {
            ...
            if (_iOnClicked != null)
                //  DOVirtual.Float(0, 0.011f, 0.2f, val => { _parrotSlider.value += val; }).SetEase(Ease.InSine);
