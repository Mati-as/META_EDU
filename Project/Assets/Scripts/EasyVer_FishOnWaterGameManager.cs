...
public class EasyVer_FishOnWaterGameManager : Base_GameManager
{
 public bool easyVersion;
    ...
    private int _currentMode = (int)OriginalHardVer_FishOnWaterBaseGameManager.PlayMode.MultiPlay;
...
#endif
            _currentMode = Math.Clamp(value, (int)OriginalHardVer_FishOnWaterBaseGameManager.PlayMode.SinglePlay, (int)OriginalHardVer_FishOnWaterBaseGameManager.PlayMode.MultiPlay);
        }
    }
   ...
   */
    ...
    public int FishCaughtCount
    {
         ...
         set
        {
            ...
            if (fishCaughtCount >= fishCountGoal && (OriginalHardVer_FishOnWaterBaseGameManager.PlayMode)currentMode == OriginalHardVer_FishOnWaterBaseGameManager.PlayMode.SinglePlay)
            {
    ...
    private void InvokeFinishAndReInit()
    {
        ...
        if (currentMode == (int)OriginalHardVer_FishOnWaterBaseGameManager.PlayMode.MultiPlay)
        {
        ...
        else if (currentMode == (int)OriginalHardVer_FishOnWaterBaseGameManager.PlayMode.SinglePlay)
        {
    ...
    protected override void BindEvent()
    {
        ...
        EasyVer_FishOnWaterUIManager.OnStartUIAppear -= OnRoundStart;
        EasyVer_FishOnWaterUIManager.OnStartUIAppear += OnRoundStart;
        
        
        EasyVer_FishOnWaterUIManager.OnStartUIAppear -= OnReadyUIAppear;
        EasyVer_FishOnWaterUIManager.OnReadyUIAppear += OnReadyUIAppear;

        EasyVer_FishOnWaterUIManager.OnRestartBtnClicked -= OnRestartBtnClicked;
        EasyVer_FishOnWaterUIManager.OnRestartBtnClicked += OnRestartBtnClicked;

        EasyVer_FishOnWaterUIManager.OnResetXML -= OnXmlReset;
        EasyVer_FishOnWaterUIManager.OnResetXML += OnXmlReset;

        EasyVer_FishOnWaterUIManager.OnResetSettingBtnClicked -= OnResetSetting;
        EasyVer_FishOnWaterUIManager.OnResetSettingBtnClicked += OnResetSetting;

        EasyVer_FishOnWaterUIManager.OnSaveCurrentSettingClicked -= OnSaveCurrentSettings;
        EasyVer_FishOnWaterUIManager.OnSaveCurrentSettingClicked += OnSaveCurrentSettings;
    }
